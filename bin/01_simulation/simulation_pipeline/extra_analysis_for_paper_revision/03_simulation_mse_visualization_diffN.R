...
for (tp in top_porp){
    ...
    for (ps in pleiotropy_scene){
        ...
        for (vs in valid_snps){
            ...
            bxp_final <- bxp + 
                        ...
                        xlab("Tau Scenarios") + ylab("MSE") + ggtitle(paste0("Pleiotropy Scene: ", pleotropic.type, "; Invalid Snp Counts (Total SNPs: 100): ", invalid.snps.count)) +
    ...
    ggsave(paste0("/mnt/md0/yujia/project/2023-07-20-individual_MR/plot/extra_analysis_for_paper_revision/mse/all_mse_diffN_", tp * 100,".png"), p.final, dpi=300, 

...
#' This is the extra analysis to investigate the performance with larger sample size and SNP set size.
#' 
#' @author Yujia Shi
#' @date 2024.08.25
  ...
  for (isns in invalid_snps_n_set){
    ...
    for (i in 1:8){ 
      ...
      while (ne <= n.experiments){
        ...
        if (!dir.exists("/mnt/md0/yujia/project/2023-07-20-individual_MR/res/extra_analysis_for_paper_revision_diffSNPs_diffN/01_simulation/tau/estimate/")){
          dir.create("/mnt/md0/yujia/project/2023-07-20-individual_MR/res/extra_analysis_for_paper_revision_diffSNPs_diffN/01_simulation/tau/estimate/", recursive = T)
        }
        if (!dir.exists("/mnt/md0/yujia/project/2023-07-20-individual_MR/res/extra_analysis_for_paper_revision_diffSNPs_diffN/01_simulation/tau/std/")){
          dir.create("/mnt/md0/yujia/project/2023-07-20-individual_MR/res/extra_analysis_for_paper_revision_diffSNPs_diffN/01_simulation/tau/std/", recursive = T)
        }

        fwrite(taus.mat.estimate, paste0("/mnt/md0/yujia/project/2023-07-20-individual_MR/res/extra_analysis_for_paper_revision_diffSNPs_diffN/01_simulation/tau/estimate/", scenario.index, "_", isns, "_", i, "_", ne,"_estimate.csv.gz"))
        fwrite(taus.mat.std, paste0("/mnt/md0/yujia/project/2023-07-20-individual_MR/res/extra_analysis_for_paper_revision_diffSNPs_diffN/01_simulation/tau/std/", scenario.index, "_", isns, "_", i, "_", ne,"_std.csv.gz")) 
      ...
      if (!dir.exists("/mnt/md0/yujia/project/2023-07-20-individual_MR/res/extra_analysis_for_paper_revision_diffSNPs_diffN/01_simulation/mse/")){
        dir.create("/mnt/md0/yujia/project/2023-07-20-individual_MR/res/extra_analysis_for_paper_revision_diffSNPs_diffN/01_simulation/mse/", recursive = T)
      }

      fwrite(res.mat, paste0("/mnt/md0/yujia/project/2023-07-20-individual_MR/res/extra_analysis_for_paper_revision_diffSNPs_diffN/01_simulation/mse/", scenario.index, "_", isns, "_", i, "_res.csv"))

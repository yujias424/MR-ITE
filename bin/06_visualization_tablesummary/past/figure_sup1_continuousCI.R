...
# DRIV
# # tau.summary.LDL.CAD.train <- read.csv("~/Project/2022-09-01-individual_MR/res/table/LDL/heart_disease/treatment_effect/driv_train_continuousWZ_te_ul.csv")
# # tau.summary.LDL.CAD.test <- read.csv("~/Project/2022-09-01-individual_MR/res/table/LDL/heart_disease/treatment_effect/driv_test_continuousWZ_te_ul.csv")
# # tau.summary.LDL.CAD <- rbind(tau.summary.LDL.CAD.train, tau.summary.LDL.CAD.test)
# 
# tau.summary.LDL.CAD <- read.csv("~/Project/2022-09-01-individual_MR/res/table/LDL/heart_disease/treatment_effect/driv_full_continuousWZ_te_ul.csv")

# IV-GRF
tau.summary.LDL.CAD <- read.csv("~/Project/2022-09-01-individual_MR/res/table/LDL/heart_disease/treatment_effect/ivgrf_full_continuousWZ_var.csv")
...
tau.summary.LDL.CAD$sigP <- ifelse(tau.summary.LDL.CAD$lower_bound > 0, "Yes", "No")
tau.summary.LDL.CAD <- tau.summary.LDL.CAD[order(tau.summary.LDL.CAD$sigP, tau.summary.LDL.CAD$lower_bound),]
...
# DRIV
# # tau.summary.LDL.IS.train <- read.csv("~/Project/2022-09-01-individual_MR/res/table/LDL/ischemic_stroke/treatment_effect/driv_train_continuousWZ_te_ul.csv")
# # tau.summary.LDL.IS.test <- read.csv("~/Project/2022-09-01-individual_MR/res/table/LDL/ischemic_stroke/treatment_effect/driv_test_continuousWZ_te_ul.csv")
# # tau.summary.LDL.IS <- rbind(tau.summary.LDL.IS.train, tau.summary.LDL.IS.test)
# 
# tau.summary.LDL.IS <- read.csv("~/Project/2022-09-01-individual_MR/res/table/LDL/ischemic_stroke/treatment_effect/driv_full_continuousWZ_te_ul.csv")

# IV-GRF
tau.summary.LDL.IS <- read.csv("~/Project/2022-09-01-individual_MR/res/table/LDL/ischemic_stroke/treatment_effect/ivgrf_full_continuousWZ_var.csv")
...
tau.summary.LDL.IS$sigP <- ifelse(tau.summary.LDL.IS$lower_bound > 0, "Yes", "No")
tau.summary.LDL.IS <- tau.summary.LDL.IS[order(tau.summary.LDL.IS$sigP, tau.summary.LDL.IS$lower_bound),]
...
# DRIV
# tau.summary.HDL.CAD.train <- read.csv("~/Project/2022-09-01-individual_MR/res/table/HDL/heart_disease/treatment_effect/driv_train_continuousWZ_te_ul.csv")
# tau.summary.HDL.CAD.test <- read.csv("~/Project/2022-09-01-individual_MR/res/table/HDL/heart_disease/treatment_effect/driv_test_continuousWZ_te_ul.csv")
# tau.summary.HDL.CAD <- rbind(tau.summary.HDL.CAD.train, tau.summary.HDL.CAD.test)
# 
# # tau.summary.HDL.CAD <- read.csv("~/Project/2022-09-01-individual_MR/res/table/HDL/heart_disease/treatment_effect/driv_full_continuousWZ_te_ul.csv")

# IV-GRF
tau.summary.HDL.CAD <- read.csv("~/Project/2022-09-01-individual_MR/res/table/HDL/heart_disease/treatment_effect/ivgrf_full_continuousWZ_var.csv")
...
# DRIV
# # tau.summary.HDL.IS.train <- read.csv("~/Project/2022-09-01-individual_MR/res/table/HDL/ischemic_stroke/treatment_effect/driv_train_continuousWZ_te_ul.csv")
# # tau.summary.HDL.IS.test <- read.csv("~/Project/2022-09-01-individual_MR/res/table/HDL/ischemic_stroke/treatment_effect/driv_test_continuousWZ_te_ul.csv")
# # tau.summary.HDL.IS <- rbind(tau.summary.HDL.IS.train, tau.summary.HDL.IS.test)
# 
# tau.summary.HDL.IS <- read.csv("~/Project/2022-09-01-individual_MR/res/table/HDL/ischemic_stroke/treatment_effect/driv_full_continuousWZ_te_ul.csv")

# IV-GRF
tau.summary.HDL.IS <- read.csv("~/Project/2022-09-01-individual_MR/res/table/HDL/ischemic_stroke/treatment_effect/ivgrf_full_continuousWZ_var.csv")
...
# DRIV
# tau.summary.TG.CAD.train <- read.csv("~/Project/2022-09-01-individual_MR/res/table/TG/heart_disease/treatment_effect/driv_train_continuousWZ_te_ul.csv")
# tau.summary.TG.CAD.test <- read.csv("~/Project/2022-09-01-individual_MR/res/table/TG/heart_disease/treatment_effect/driv_test_continuousWZ_te_ul.csv")
# tau.summary.TG.CAD <- rbind(tau.summary.TG.CAD.train, tau.summary.TG.CAD.test)
# 
# # tau.summary.TG.CAD <- read.csv("~/Project/2022-09-01-individual_MR/res/table/TG/heart_disease/treatment_effect/driv_full_continuousWZ_te_ul.csv")

# IV-GRF
tau.summary.TG.CAD <- read.csv("~/Project/2022-09-01-individual_MR/res/table/TG/heart_disease/treatment_effect/ivgrf_full_continuousWZ_var.csv")
...
tau.summary.TG.CAD$sigP <- ifelse(tau.summary.TG.CAD$lower_bound > 0, "Yes", "No")
tau.summary.TG.CAD <- tau.summary.TG.CAD[order(tau.summary.TG.CAD$sigP, tau.summary.TG.CAD$lower_bound),]
...
# DRIV
# # tau.summary.TG.IS.train <- read.csv("~/Project/2022-09-01-individual_MR/res/table/TG/ischemic_stroke/treatment_effect/driv_train_continuousWZ_te_ul.csv")
# # tau.summary.TG.IS.test <- read.csv("~/Project/2022-09-01-individual_MR/res/table/TG/ischemic_stroke/treatment_effect/driv_test_continuousWZ_te_ul.csv")
# # tau.summary.TG.IS <- rbind(tau.summary.TG.IS.train, tau.summary.TG.IS.test)
# 
# tau.summary.TG.IS <- read.csv("~/Project/2022-09-01-individual_MR/res/table/TG/ischemic_stroke/treatment_effect/driv_full_continuousWZ_te_ul.csv")

# IV-GRF
tau.summary.TG.IS <- read.csv("~/Project/2022-09-01-individual_MR/res/table/TG/ischemic_stroke/treatment_effect/ivgrf_full_continuousWZ_var.csv")
...
tau.summary.TG.IS$sigP <- ifelse(tau.summary.TG.IS$lower_bound > 0, "Yes", "No")
tau.summary.TG.IS <- tau.summary.TG.IS[order(tau.summary.TG.IS$sigP, tau.summary.TG.IS$lower_bound),]
...
# DRIV
# tau.summary.TC.CAD.train <- read.csv("~/Project/2022-09-01-individual_MR/res/table/TC/heart_disease/treatment_effect/driv_train_continuousWZ_te_ul.csv")
# tau.summary.TC.CAD.test <- read.csv("~/Project/2022-09-01-individual_MR/res/table/TC/heart_disease/treatment_effect/driv_test_continuousWZ_te_ul.csv")
# tau.summary.TC.CAD <- rbind(tau.summary.TC.CAD.train, tau.summary.TC.CAD.test)
# 
# # tau.summary.TC.CAD <- read.csv("~/Project/2022-09-01-individual_MR/res/table/TC/heart_disease/treatment_effect/driv_full_continuousWZ_te_ul.csv")

# IV-GRF
tau.summary.TC.CAD <- read.csv("~/Project/2022-09-01-individual_MR/res/table/TC/heart_disease/treatment_effect/ivgrf_full_continuousWZ_var.csv")
...
tau.summary.TC.CAD$sigP <- ifelse(tau.summary.TC.CAD$lower_bound > 0, "Yes", "No")
tau.summary.TC.CAD <- tau.summary.TC.CAD[order(tau.summary.TC.CAD$sigP, tau.summary.TC.CAD$lower_bound),]
...
# DRIV
# # tau.summary.TC.IS.train <- read.csv("~/Project/2022-09-01-individual_MR/res/table/TC/ischemic_stroke/treatment_effect/driv_train_continuousWZ_te_ul.csv")
# # tau.summary.TC.IS.test <- read.csv("~/Project/2022-09-01-individual_MR/res/table/TC/ischemic_stroke/treatment_effect/driv_test_continuousWZ_te_ul.csv")
# # tau.summary.TC.IS <- rbind(tau.summary.TC.IS.train, tau.summary.TC.IS.test)
# 
# tau.summary.TC.IS <- read.csv("~/Project/2022-09-01-individual_MR/res/table/TC/ischemic_stroke/treatment_effect/driv_full_continuousWZ_te_ul.csv")

# IV-GRF
tau.summary.TC.IS <- read.csv("~/Project/2022-09-01-individual_MR/res/table/TC/ischemic_stroke/treatment_effect/ivgrf_full_continuousWZ_var.csv")
...
tau.summary.TC.IS$sigP <- ifelse(tau.summary.TC.IS$lower_bound > 0, 1, 0)
tau.summary.TC.IS <- tau.summary.TC.IS[order(tau.summary.TC.IS$sigP, tau.summary.TC.IS$lower_bound),]
...
res
ggsave("~/Project/2022-09-01-individual_MR/res/plot/Manuscript/Figure/withTG/Figure_sup1_continuousCI_ivgrf.png", plot = res, width = 20,
       height = 25, bg = "white")
...
res <- plot_grid(prow, legend, rel_widths = c(3, .4))
res
ggsave("~/Project/2022-09-01-individual_MR/res/plot/Manuscript/Figure/withoutTG/Figure_sup1_continuousCI_ivgrf.png", plot = res, width = 20,
       height = 20, bg = "white")

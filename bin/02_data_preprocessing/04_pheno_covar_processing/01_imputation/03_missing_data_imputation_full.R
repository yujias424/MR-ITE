...
save.image("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/ukbb_covariate_imputed_fullset.RData")

#' ===================
#' Generate the X data
#' ===================

load("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/ukbb_covariate_imputed_fullset.RData")
...
colnames(covar.select.imp) <- c("FID", "IID", 
                                ...
                                "30880-0.0", # Urate
                                "30890-0.0") # Vitamin D
fwrite(covar.select.imp, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/ukbb.covariate.imputed.fullset.gz")

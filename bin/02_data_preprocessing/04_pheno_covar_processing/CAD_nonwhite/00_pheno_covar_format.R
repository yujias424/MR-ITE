...
# write covar data
fwrite(covar.set.1.df, "/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/external_analysis_for_paper_revision/traits/ukbb.covariate.traits.set1.gz", sep = "\t")
fwrite(covar.set.2.df, "/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/external_analysis_for_paper_revision/traits/ukbb.covariate.traits.set2.gz", sep = "\t")

dir.create("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/external_analysis_for_paper_revision/HDL/CAD/", showWarnings = FALSE, recursive = TRUE)
dir.create("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/external_analysis_for_paper_revision/LDL/CAD/", showWarnings = FALSE, recursive = TRUE)
dir.create("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/external_analysis_for_paper_revision/TC/CAD/", showWarnings = FALSE, recursive = TRUE)
dir.create("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/external_analysis_for_paper_revision/TG/CAD/", showWarnings = FALSE, recursive = TRUE)

fwrite(covar.set.3.HDL.df, "/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/external_analysis_for_paper_revision/HDL/CAD/ukbb.covariate.HDL.set3.gz", sep = "\t")
fwrite(covar.set.3.LDL.df, "/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/external_analysis_for_paper_revision/LDL/CAD/ukbb.covariate.LDL.set3.gz", sep = "\t")
fwrite(covar.set.3.TC.df, "/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/external_analysis_for_paper_revision/TC/CAD/ukbb.covariate.TC.set3.gz", sep = "\t")
fwrite(covar.set.3.TG.df, "/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/external_analysis_for_paper_revision/TG/CAD/ukbb.covariate.TG.set3.gz", sep = "\t")

fwrite(pheno.HDL.mmolL, "/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/external_analysis_for_paper_revision/HDL/CAD/ukbb.phenotype.HDL.mmolL", sep = "\t")
fwrite(pheno.HDL.mgdL, "/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/external_analysis_for_paper_revision/HDL/CAD/ukbb.phenotype.HDL.mgdL", sep = "\t")
fwrite(pheno.LDL.mmolL, "/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/external_analysis_for_paper_revision/LDL/CAD/ukbb.phenotype.LDL.mmolL", sep = "\t")
fwrite(pheno.LDL.mgdL, "/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/external_analysis_for_paper_revision/LDL/CAD/ukbb.phenotype.LDL.mgdL", sep = "\t")
fwrite(pheno.TC.mmolL, "/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/external_analysis_for_paper_revision/TC/CAD/ukbb.phenotype.TC.mmolL", sep = "\t")
fwrite(pheno.TC.mgdL, "/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/external_analysis_for_paper_revision/TC/CAD/ukbb.phenotype.TC.mgdL", sep = "\t")
fwrite(pheno.TG.mmolL, "/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/external_analysis_for_paper_revision/TG/CAD/ukbb.phenotype.TG.mmolL", sep = "\t")
fwrite(pheno.TG.mgdL, "/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/external_analysis_for_paper_revision/TG/CAD/ukbb.phenotype.TG.mgdL", sep = "\t")

...
fwrite(X.model1 , "/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/external_analysis_for_paper_revision/LDL/CAD/ukbb.covariate.prs.LDL.set1", sep = "\t")
...
setnames(X.model2 , c("22001-0.0", "21022-0.0", "22000-0.0", 
                    ...
                    c("Gender", "Age", "Genotype_Batch", 
                      "PC1", "PC2", "PC3", "PC4", "PC5", "PC6", "PC7", "PC8", "PC9", "PC10"))
fwrite(X.model2 , "/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/external_analysis_for_paper_revision/LDL/CAD/ukbb.covariate.prs.LDL.set2", sep = "\t")
...
setnames(X.model3 , c("22001-0.0", "21022-0.0", "22000-0.0", 
                    ...
                    c("Gender", "Age", "Genotype_Batch", 
                      "PC1", "PC2", "PC3", "PC4", "PC5", "PC6", "PC7", "PC8", "PC9", "PC10"))
fwrite(X.model3 , "/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/external_analysis_for_paper_revision/LDL/CAD/ukbb.covariate.prs.LDL.set3", sep = "\t")
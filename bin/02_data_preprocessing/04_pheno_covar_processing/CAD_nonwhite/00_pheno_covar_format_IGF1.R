...
# Phenotype (IGF1)
pheno.IGF1.nmolL <- covar[, c("FID", "IID", "30770-0.0")]

# convert nmol/L to ug/dL to mg/dL (# https://unitslab.com/node/230)
pheno.IGF1.mgdL <- pheno.IGF1.nmolL
pheno.IGF1.mgdL$`30770-0.0` <- pheno.IGF1.mgdL$`30770-0.0` * 0.7649 * 0.001 # 1nmol/L IGF-1 = 0.7649 µg/dL; 1µg/dL = 0.001 mg/dL
...
covar.set.3.IGF1.df <- covar.set.3.df[, .SD, .SDcols = !c("30770-0.0")] # IGF1

# write covar data
dir.create("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/external_analysis_for_paper_revision/IGF1/CAD/", showWarnings = FALSE, recursive = TRUE)

fwrite(covar.set.1.df, "/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/external_analysis_for_paper_revision/IGF1/CAD/ukbb.covariate.traits.set1.gz", sep = "\t")
fwrite(covar.set.2.df, "/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/external_analysis_for_paper_revision/IGF1/CAD/ukbb.covariate.traits.set2.gz", sep = "\t")
fwrite(covar.set.3.IGF1.df, "/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/external_analysis_for_paper_revision/IGF1/CAD/ukbb.covariate.IGF1.set3.gz", sep = "\t")
fwrite(pheno.IGF1.mgdL, "/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/external_analysis_for_paper_revision/IGF1/CAD/ukbb.phenotype.IGF1.mgdL", sep = "\t")
fwrite(pheno.IGF1.nmolL, "/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/external_analysis_for_paper_revision/IGF1/CAD/ukbb.phenotype.IGF1.nmolL", sep = "\t")

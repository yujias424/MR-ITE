...
#' causal relationship between CystatinC and CAD.
#' 
#' @author: Yujia Shi
#' @date: 2022.09.01
...
X.set3 <- fread("/home/yujia/Project/2023-07-20-individual_MR/dat/04_pheno_covar_data/CystatinC/CAD/ukbb.covariate.CystatinC.set3.gz", sep = "\t")

W <- fread("~/Project/2023-07-20-individual_MR/dat/04_pheno_covar_data/CystatinC/CAD/ukbb.phenotype.CystatinC.mgdL", sep = "\t")
...
fwrite(X.model1 , "/home/yujia/Project/2023-07-20-individual_MR/dat/04_pheno_covar_data/CystatinC/CAD/ukbb.covariate.prs.CystatinC.set1", sep = "\t")
...
setnames(X.model2 , c("22001-0.0", "21022-0.0", "22000-0.0", 
                    ...
                    c("Gender", "Age", "Genotype_Batch", 
                      "PC1", "PC2", "PC3", "PC4", "PC5", "PC6", "PC7", "PC8", "PC9", "PC10"))
fwrite(X.model2 , "/home/yujia/Project/2023-07-20-individual_MR/dat/04_pheno_covar_data/CystatinC/CAD/ukbb.covariate.prs.CystatinC.set2", sep = "\t")
...
setnames(X.model3 , c("22001-0.0", "21022-0.0", "22000-0.0", 
                    ...
                    c("Gender", "Age", "Genotype_Batch", 
                      "PC1", "PC2", "PC3", "PC4", "PC5", "PC6", "PC7", "PC8", "PC9", "PC10"))
fwrite(X.model3 , "/home/yujia/Project/2023-07-20-individual_MR/dat/04_pheno_covar_data/CystatinC/CAD/ukbb.covariate.prs.CystatinC.set3", sep = "\t")
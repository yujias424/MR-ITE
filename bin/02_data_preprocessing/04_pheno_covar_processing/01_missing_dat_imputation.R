...
covar <- fread("/home/yujia/Project/2023-07-20-individual_MR/dat/04_pheno_covar_data/ukbb.covariate.gz") # exclude non-genetic white and include all PC

# only select patients with Genetic ethnic grouping = 1 and included in PCA calculation
covar <- covar[covar$`22006-0.0` == 1] # we only include Caucasian here, where 22006-0.0 = 1
...
save.image("/home/yujia/Project/2023-07-20-individual_MR/dat/04_pheno_covar_data/ukbb_covariate_imputed.RData")

#' ===================
#' Generate the X data
#' ===================

load("/home/yujia/Project/2023-07-20-individual_MR/dat/04_pheno_covar_data/ukbb_covariate_imputed.RData")
...
colnames(covar.select.imp) <- c("FID", "IID", 
                                ...
                                "30880-0.0", # Urate
                                "30890-0.0") # Vitamin D
fwrite(covar.select.imp, file = "/home/yujia/Project/2023-07-20-individual_MR/dat/04_pheno_covar_data/ukbb.covariate.imputed.gz")

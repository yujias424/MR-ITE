...
tg = pd.read_csv("~/Project/2022-09-01-individual_MR/dat/02_base_data/TG/download/jointGwasMc_TG.txt.gz", sep="\t", compression = 'gzip')
...
tg.to_csv("~/Project/2022-09-01-individual_MR/dat/02_base_data/TG/QC/TG_formated_nadrop.tsv.gz", sep="\t", index=False)
...
cmd = "gunzip -c /home/yujia/Project/2022-09-01-individual_MR/dat/02_base_data/TG/QC/TG_formated_nadrop.tsv.gz |" + \
      "awk 'NR==1 || ($10 > 0.01) {print}' |" + \
      "gzip > /home/yujia/Project/2022-09-01-individual_MR/dat/02_base_data/TG/QC/TG.standardGWASQC.gz"
os.system(cmd)

cmd = "zcat /home/yujia/Project/2022-09-01-individual_MR/dat/02_base_data/TG/QC/TG.standardGWASQC.gz | wc -l"
...
cmd = "gunzip -c /home/yujia/Project/2022-09-01-individual_MR/dat/02_base_data/TG/QC/TG.standardGWASQC.gz |" + \
      "awk '{seen[$3]++; if(seen[$3]==1){ print}}' |" + \
      "gzip - > /home/yujia/Project/2022-09-01-individual_MR/dat/02_base_data/TG/QC/TG.nodup.gz"
os.system(cmd)

cmd = "zcat /home/yujia/Project/2022-09-01-individual_MR/dat/02_base_data/TG/QC/TG.nodup.gz | wc -l"
...
cmd = "gunzip -c /home/yujia/Project/2022-09-01-individual_MR/dat/02_base_data/TG/QC/TG.nodup.gz | " + \
      "awk '!( ($4==\"A\" && $5==\"T\") || ($4==\"T\" && $5==\"A\") || ($4==\"G\" && $5==\"C\") || ($4==\"C\" && $5==\"G\")) {print}' | " + \
      "gzip > /home/yujia/Project/2022-09-01-individual_MR/dat/02_base_data/TG/QC/TG.QC.gz"
os.system(cmd)

cmd = "zcat /home/yujia/Project/2022-09-01-individual_MR/dat/02_base_data/TG/QC/TG.QC.gz | wc -l"

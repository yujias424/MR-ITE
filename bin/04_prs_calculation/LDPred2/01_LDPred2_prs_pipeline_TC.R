...
# =================================================
phenotype <- fread("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/external_analysis_for_paper_revision/TC/CAD/ukbb.phenotype.TC.mgdL")
covariate <- fread("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/external_analysis_for_paper_revision/TC/CAD/ukbb.covariate.prs.TC.set1")
...
valid.snps <- fread("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/06_PRS_calculation/external_analysis_for_paper_revision/LDPred2/EUR/TC/CAD/selected_snps_0.2.csv")

# Load and transform the summary statistic file
# Read in the summary statistic file
sumstats <- bigreadr::fread2("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/02_base_data/TC/QC/TC.QC.gz") 
...
null.model <- paste("PC", 1:10, sep = "", collapse = "+") %>%
    paste0("TC~Gender+Genotype_Batch+Age+", .) %>%
    as.formula %>%
    lm(., data = y) %>%
    summary
...
dir.create("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/06_PRS_calculation/external_analysis_for_paper_revision/LDPred2/EUR/TC/CAD/set1/", recursive = T, showWarnings = F)
fwrite(PRS_final, "/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/06_PRS_calculation/external_analysis_for_paper_revision/LDPred2/EUR/TC/CAD/set1/TC_prs_0.2.csv")
...
reg.formula <- paste("PC", 1:10, sep = "", collapse = "+") %>%
    paste0("TC~PRS+Gender+Genotype_Batch+Age+", .) %>%
    as.formula
reg.dat <- y

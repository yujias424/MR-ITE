                ...
                for (p in 1:length(p.value.cutoff)){
                    ...
                    if (sa == "set1"){
                        commands <- paste0("/home/yujia/Software/PRSice/PRSice_linux ",
                                            ...
                                            "--base /mnt/md0/yujia/project/2023-07-20-individual_MR/dat/02_base_data/", t, "/QC/", t, ".", bd, ".QC.gz ", 
                                            "--beta ",  
                                            "--binary-target F ", 
                                            "--clump-kb 250kb ",
                                            "--clump-p 1.000000 ",
                                            ...
                                            "--thread 35 ",
                                            "--score con-std ",
                                            "--extract /mnt/md0/yujia/project/2023-07-20-individual_MR/dat/06_PRS_calculation/external_analysis_for_paper_revision/PRSice2/", t, "/", i, "/selected_snps_", p.value.cutoff[p], "_", bd, ".csv")
                    } else if (sa == "set2") {
                        commands <- paste0("/home/yujia/Software/PRSice/PRSice_linux ",
                                            "--a1 A1 ",
                                            "--a2 A2 ",

            ...
            for (p in 1:length(p.value.cutoff)){
                ...
                if (sa == "set1"){
                    commands <- paste0("/home/yujia/Software/PRSice/PRSice_linux ",
                                        ...
                                        "--base /mnt/md0/yujia/project/2023-07-20-individual_MR/dat/02_base_data/", t, "/QC/", t, ".QC.gz ", # .QC.wthPos.
                                        "--beta ",  
                                        "--binary-target F ", 
                                        "--clump-kb 250kb ",
                                        "--clump-p 1.000000 ",
                    ...
                    commands <- paste0("/home/yujia/Software/PRSice/PRSice_linux ",
                                        ...
                                        "--bp BP ",
                                        "--chr CHR ", "--bar-levels ", barlevels[1], "--fastscore ", 
                                        "--base /mnt/md0/yujia/project/2023-07-20-individual_MR/dat/02_base_data/", t, "/QC/", t, ".QC.gz ", 
                                        "--beta ",  
                                        "--binary-target F ", 
                                        "--clump-kb 250kb ",
                                        "--clump-p 1.000000 ",

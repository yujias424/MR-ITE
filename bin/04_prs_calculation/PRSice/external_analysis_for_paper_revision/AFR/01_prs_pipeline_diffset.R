    ...
    for (sa in set_arr){
        for (i in diseases){
            ...
            for (p in 1:length(p.value.cutoff)){
                ...
                dir.create(paste0("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/06_PRS_calculation/external_analysis_for_paper_revision/PRSice2/AFR/", t, "/", i, "/", sa, "/", p.value.cutoff[p]), recursive = T, showWarnings = F)
                setwd(paste0("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/06_PRS_calculation/external_analysis_for_paper_revision/PRSice2/AFR/", t, "/", i, "/", sa, "/", p.value.cutoff[p]))
                ...
                if (sa == "set1"){
                    commands <- paste0("/home/yujia/Software/PRSice/PRSice_linux ",
                                        ...
                                        "--base /mnt/md0/yujia/project/2023-07-20-individual_MR/dat/02_base_data/", t, "/QC_AFR/", t, ".QC.gz ", # .QC.wthPos.
                                        "--beta ",  
                                        "--binary-target F ", 
                                        "--clump-kb 250kb ",
                                        "--clump-p 1.000000 ",
                                        ...
                                        "--thread 35 ",
                                        "--score con-std ", 
                                        "--extract /mnt/md0/yujia/project/2023-07-20-individual_MR/dat/06_PRS_calculation/external_analysis_for_paper_revision/PRSice2/AFR/", t, "/", i, "/selected_snps_", p.value.cutoff[p],".AFR.csv")
                } else {
                    commands <- paste0("/home/yujia/Software/PRSice/PRSice_linux ",
                                        "--a1 A1 ",
                                        "--a2 A2 ",
                                        "--bp BP ",
                                        "--chr CHR ", "--bar-levels ", barlevels[1], "--fastscore ", 
                                        "--base /mnt/md0/yujia/project/2023-07-20-individual_MR/dat/02_base_data/", t, "/QC_AFR/", t, ".QC.gz ", 
                                        "--beta ",  
                                        "--binary-target F ", 
                                        "--clump-kb 250kb ",
                                        "--clump-p 1.000000 ",

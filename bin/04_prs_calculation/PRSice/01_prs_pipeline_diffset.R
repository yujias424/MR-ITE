            ...
            for (p in 1:length(p.value.cutoff)){
                ...
                if (sa == "set1"){
                    commands <- paste0("/home/yujia/software/PRSice-235/PRSice_linux ",
                                        ...
                                        "--base /home/yujia/Project/2022-09-01-individual_MR/dat/02_base_data/", t, "/QC/", t, ".QC.gz ", # .QC.wthPos.
                                        "--beta ",  
                                        "--binary-target F ", 
                                        "--clump-kb 250kb ",
                                        "--clump-p 1.000000 ",
                    ...
                    commands <- paste0("/home/yujia/software/PRSice-235/PRSice_linux ",
                                        ...
                                        "--bp BP ",
                                        "--chr CHR ", "--bar-levels ", barlevels[1], "--fastscore ", 
                                        "--base /home/yujia/Project/2022-09-01-individual_MR/dat/02_base_data/", t, "/QC/", t, ".QC.gz ", 
                                        "--beta ",  
                                        "--binary-target F ", 
                                        "--clump-kb 250kb ",
                                        "--clump-p 1.000000 ",

    ...
    for (sa in set_arr){
        for (i in diseases){
            ...
            for (p in 1:length(p.value.cutoff)){
                ...
                dir.create(paste0("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/06_PRS_calculation/", t, "/", i, "/", sa, "/", p.value.cutoff[p]), recursive = T, showWarnings = F)
                setwd(paste0("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/06_PRS_calculation/", t, "/", i, "/", sa, "/", p.value.cutoff[p]))
                ...
                if (sa == "set1"){
                    commands <- paste0("/home/yujia/Software/PRSice/PRSice_linux ",
                                        ...
                                        "--num-auto 22 ",
                                        "--out ", t, "_prs ",
                                        "--pheno /mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/", t, "/", i, "/ukbb.phenotype.", t, ".nmolL ", 
                                        "--print-snp ",
                                        "--pvalue P ",
                                        "--seed 2389825711 ",
                                        "--snp SNP ",
                                        ...
                                        "--thread 35 ",
                                        "--score avg ", # con-std
                                        "--extract /mnt/md0/yujia/project/2023-07-20-individual_MR/dat/06_PRS_calculation/", t, "/", i, "/selected_snps_", p.value.cutoff[p],".csv")
                } else if (sa == "set2") {
                    commands <- paste0("/home/yujia/Software/PRSice/PRSice_linux ",
                                        "--a1 A1 ",
                                        "--a2 A2 ",

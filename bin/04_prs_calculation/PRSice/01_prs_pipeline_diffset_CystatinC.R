...
####### lipid traits #######
# traits <- c("LDL", "TC", "TG")
traits <- c("CystatinC") #"CRP", "CystatinC"
diseases <- c("CAD")
            ...
            for (p in 1:length(p.value.cutoff)){
                ...
                if (sa == "set1"){
                    commands <- paste0("/home/yujia/software/PRSice-235/PRSice_linux ",
                                        ...
                                        "--base /home/yujia/Project/2023-07-20-individual_MR/dat/02_base_data/", t, "/QC/", t, ".QC.withPos.gz ", # .QC.wthPos.
                                        "--beta ",  
                                        "--binary-target F ", 
                                        "--clump-kb 250kb ",
                                        "--clump-p 1.000000 ",
                                        ...
                                        "--thread 15 ",
                                        "--score con-std ", 
                                        "--extract /home/yujia/Project/2023-07-20-individual_MR/dat/06_PRS_calculation/", t, "/", i, "/selected_snps_", p.value.cutoff[p],".csv")
                } else if (sa == "set2") {
                    commands <- paste0("/home/yujia/software/PRSice-235/PRSice_linux ",
                                        "--a1 A1 ",
                                        "--a2 A2 ",
                                        "--bp BP ",
                                        "--chr CHR ", "--bar-levels ", barlevels[1], "--fastscore ", 
                                        "--base /home/yujia/Project/2023-07-20-individual_MR/dat/02_base_data/", t, "/QC/", t, ".QC.withPos.gz ", 
                                        "--beta ",  
                                        "--binary-target F ", 
                                        "--clump-kb 250kb ",
                                        "--clump-p 1.000000 ",

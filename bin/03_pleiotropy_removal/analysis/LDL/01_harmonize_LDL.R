...
# exposure <- fread(paste0("/home/yujia/Project/2022-09-01-individual_MR/dat/02_base_data/", trait, "/QC/", trait, ".QC.gz"), sep = "\t")
...
trait <- "LDL"
ldl_exp_dat.origin <- read_exposure_data(paste0("~/Project/2023-07-20-individual_MR/dat/05_two_sample_mr/exposure.", trait, ".txt"))

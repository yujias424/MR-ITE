...
ggsave("/home/yujia/Project/2023-07-20-individual_MR/res/03_plot/supp_fig1_TC_CAD_binary.png", plot = p.validation, dpi = 300,
...
# # plotting
# tree_plot
# cat(DiagrammeRsvg::export_svg(tree_plot), file = '/home/yujia/Project/2023-07-20-individual_MR/res/03_plot/update_besttree/binaryW_TC_CAD_besttree.svg')

...
ggsave("/home/yujia/Project/2023-07-20-individual_MR/res/03_plot/supp_fig1_TC_CAD_continuous.png", plot = p.validation, dpi = 300,
...
# # plotting
# tree_plot
# cat(DiagrammeRsvg::export_svg(tree_plot), file = '/home/yujia/Project/2023-07-20-individual_MR/res/03_plot/update_besttree/continuousW_TC_CAD_besttree.svg')

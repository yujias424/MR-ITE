...
save.image("/home/yujia/Project/2023-07-20-individual_MR/res/02_ITE_analysis/03_validation/continuousW_LDL_CAD.RData")
# ========================================================================================
...
library(rsvg)
cat(DiagrammeRsvg::export_svg(tree_plot), file = '/home/yujia/Project/2023-07-20-individual_MR/res/03_plot/continuousW_LDL_CAD_besttree.svg')
tree_plot %>% export_svg %>% charToRaw %>% rsvg_pdf("'/home/yujia/Project/2023-07-20-individual_MR/res/03_plot/continuousW_LDL_CAD_besttree.pdf")

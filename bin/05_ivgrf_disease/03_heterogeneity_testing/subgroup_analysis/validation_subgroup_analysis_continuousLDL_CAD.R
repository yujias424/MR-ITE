...
# Data Preprocessing
# ==================
X.set3 <- fread("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/LDL/CAD/ukbb.covariate.LDL.set3.gz", sep = "\t")
Z.set3 <- fread("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/06_PRS_calculation/LDL/CAD/set3/1e-08/LDL_prs.best", sep = " ") # score_constd
W <- fread("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/LDL/CAD/ukbb.phenotype.LDL.mgdL", sep = "\t")
...
ggsave("/home/yujia/Project/2023-07-20-individual_MR/res/03_plot/supp_fig1_LDL_CAD_continuous.png", plot = p.validation, dpi = 300,
       height = 10, width = 10, scale = 1)

# save.image("/home/yujia/Project/2023-07-20-individual_MR/res/02_ITE_analysis/03_validation_update/continuousW_LDL_CAD.RData")
# ========================================================================================
...
# library(rsvg)
# cat(DiagrammeRsvg::export_svg(tree_plot), file = '/home/yujia/Project/2023-07-20-individual_MR/res/03_plot/update_besttree/continuousW_LDL_CAD_besttree.svg')
# tree_plot %>% export_svg %>% charToRaw %>% rsvg_pdf("'/home/yujia/Project/2023-07-20-individual_MR/res/03_plot/update_besttree/continuousW_LDL_CAD_besttree.pdf")

...
# iv.forest.continuousZ.rawmodel <- instrumental_forest(X.model3.mat, Y.model3.vector, W.model3.vector, Z.model3.vector, 
...
iv.forest.continuousZ.validatemodel <- instrumental_forest(X.model3.mat, Y.model3.vector, W.model3.vector, Z.model3.vector, 
                                                           num.threads = 10, num.trees = 5000, 
                                                           sample.fraction = 0.025, min.node.size = 300, ci.group.size = 100)
...
subgroup.index <- subgroup_patients(best.tree, X.model3.mat)
...
X.train <- X.model3.mat[best.tree$drawn_samples, ]
...
X.test <- X.model3.mat[-best.tree$drawn_samples, ]
...
save.image("/home/yujia/Project/2023-07-20-individual_MR/res/02_ITE_analysis/03_validation/continuousW_TC_CAD.RData")
# ========================================================================================
...
# plotting
tree_plot
cat(DiagrammeRsvg::export_svg(tree_plot), file = '/home/yujia/Project/2023-07-20-individual_MR/res/03_plot/continuousW_TC_CAD_besttree.svg')
# tree_plot %>% export_svg %>% charToRaw %>% rsvg_pdf("'/home/yujia/Project/2023-07-20-individual_MR/res/03_plot/continuousW_TC_CAD_besttree.pdf")

...
ggsave("/mnt/md0/yujia/project/2023-07-20-individual_MR/res/03_plot/supp_fig1_TC_CAD_binary.png", plot = p.validation, dpi = 300,
       height = 10, width = 10, scale = 1)

# save.image("/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/03_validation/binaryW_TC_CAD.RData")
# ========================================================================================
...
# # plotting
# tree_plot
# cat(DiagrammeRsvg::export_svg(tree_plot), file = '/mnt/md0/yujia/project/2023-07-20-individual_MR/res/03_plot/update_besttree/binaryW_TC_CAD_besttree.svg')

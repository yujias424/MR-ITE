...
# iv.forest.continuousZ.rawmodel <- instrumental_forest(X.model3.mat, Y.model3.vector, W.model3.vector.binary, Z.model3.vector, 
...
iv.forest.continuousZ.validatemodel <- instrumental_forest(X.model3.mat, Y.model3.vector, W.model3.vector.binary, Z.model3.vector, 
                                                           num.threads = 10, num.trees = 5000,
                                                           sample.fraction = 0.02, min.node.size = 200, ci.group.size = 100)
...
save.image("/home/yujia/Project/2023-07-20-individual_MR/res/02_ITE_analysis/03_validation/binaryW_LDL_CAD.RData")
# ========================================================================================
...
# plotting
tree_plot
cat(DiagrammeRsvg::export_svg(tree_plot), file = '/home/yujia/Project/2023-07-20-individual_MR/res/03_plot/binaryLDL_CAD_besttree.svg')
ggsave(filename = "/home/yujia/Project/2022-09-01-individual_MR/res/03_plot/binaryLDL_CAD_boxplot.png", plot = p.validation, dpi = 300)
sample.df

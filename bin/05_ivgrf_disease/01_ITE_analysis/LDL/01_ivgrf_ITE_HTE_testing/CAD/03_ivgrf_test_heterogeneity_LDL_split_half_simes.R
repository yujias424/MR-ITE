...
write.csv(perm_var_mat, "/home/yujia/Project/2022-09-01-individual_MR/res/02_ITE_analysis/06_validation_test_res/LDL_CAD_var.csv", row.names = T)
write.csv(perm_risk_mat, "/home/yujia/Project/2022-09-01-individual_MR/res/02_ITE_analysis/06_validation_test_res/LDL_CAD_risk.csv", row.names = T)

...
X.set1 <- fread("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/traits/ukbb.covariate.traits.set1.gz", sep = "\t")
X.set2 <- fread("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/traits/ukbb.covariate.traits.set2.gz", sep = "\t")
X.set3 <- fread("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/IGF1/CAD/ukbb.covariate.IGF1.set3.gz", sep = "\t")

Z.set1 <- fread("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/06_PRS_calculation/IGF1/CAD/set1/5e-05/IGF1_prs.best", sep = " ") # score_constd
Z.set2 <- fread("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/06_PRS_calculation/IGF1/CAD/set2/5e-05/IGF1_prs.best", sep = " ") # score_constd
Z.set3 <- fread("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/06_PRS_calculation/IGF1/CAD/set3/5e-05/IGF1_prs.best", sep = " ") # score_constd
W <- fread("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/IGF1/CAD/ukbb.phenotype.IGF1.nmolL", sep = "\t")
...
# write.csv(wald.test.res, "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/IGF1/CAD/01_individual_treatment_effect/wald_test.csv")
...
iv.forest.continuousW.model3 <- instrumental_forest(X.model3.mat, Y.model3.vector, W.model3.vector, Z.model3.vector, 
                                             num.threads = 35, num.trees = 5000, 
                                             sample.fraction = 0.03, min.node.size = 200, ci.group.size = 100)
iv.pred.continuousW.model3 <- predict(iv.forest.continuousW.model3, estimate.variance = TRUE, num.threads = 35)
...
write.csv(iv.pred.continuousW.model3, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/IGF1/CAD/01_individual_treatment_effect/ivgrf_full_continuousW_var_model3.csv")
write.csv(iv.pred.stats.continuousW.model3, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/IGF1/CAD/01_individual_treatment_effect/ivgrf_full_continuousW_pvalue_model3.csv")
...
write.csv(iv.variable_importance.continuousW.model3, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/IGF1/CAD/03_variable_importance/ivgrf_continuousW_variable_importance_model3.csv")
...
causal.forest.model3 <- causal_forest(X.model3.mat, Y.model3.vector, W.model3.vector, 
                                      num.threads = 35, num.trees = 5000, 
                                      sample.fraction = 0.03, min.node.size = 200, ci.group.size = 100)
cf.pred.model3 <- predict(causal.forest.model3, estimate.variance = TRUE, num.threads = 35)
cf.pred.stats.model3 <- compute_stats(cf.pred.model3)
summary(cf.pred.model3)
summary(cf.pred.stats.model3)
write.csv(cf.pred.model3, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/IGF1/CAD/01_individual_treatment_effect/cf_full_continuousW_var_model3.csv")
write.csv(cf.pred.stats.model3, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/IGF1/CAD/01_individual_treatment_effect/cf_full_continuousW_pvalue_model3.csv")
...
iv.forest.continuousW.model1b <- instrumental_forest(X.model1b.mat, Y.model1b.vector, W.model1b.vector, Z.model1b.vector, 
                                                     num.threads = 35, num.trees = 5000, 
                                                     sample.fraction = 0.03, min.node.size = 300, ci.group.size = 100)
iv.pred.continuousW.model1b <- predict(iv.forest.continuousW.model1b, estimate.variance = TRUE, num.threads = 35)
...
write.csv(iv.pred.continuousW.model1b, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/IGF1/CAD/01_individual_treatment_effect/ivgrf_full_continuousW_var_model1b.csv")
write.csv(iv.pred.stats.continuousW.model1b, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/IGF1/CAD/01_individual_treatment_effect/ivgrf_full_continuousW_pvalue_model1b.csv")
...
write.csv(iv.variable_importance.continuousW.model1b, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/IGF1/CAD/03_variable_importance/ivgrf_continuousW_variable_importance_model1b.csv")
...
causal.forest.model1b <- causal_forest(X.model1b.mat, Y.model1b.vector, W.model1b.vector, 
                                      num.threads = 35, num.trees = 5000, 
                                      sample.fraction = 0.03, min.node.size = 300, ci.group.size = 100)
cf.pred.model1b <- predict(causal.forest.model1b, estimate.variance = TRUE, num.threads = 35)
cf.pred.stats.model1b <- compute_stats(cf.pred.model1b)
summary(cf.pred.model1b)
summary(cf.pred.stats.model1b)
write.csv(cf.pred.model1b, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/IGF1/CAD/01_individual_treatment_effect/cf_full_continuousW_var_model1b.csv")
write.csv(cf.pred.stats.model1b, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/IGF1/CAD/01_individual_treatment_effect/cf_full_continuousW_pvalue_model1b.csv")

# # ===================================
# ####### binary W continuous Z #######
# # ===================================

####### We omit binary trait for IGF1 since there is no a exact conclusion for the optiaml cutoff for IGF1. #######
...
#                                          num.threads = 35, num.trees = 5000,
#                                          sample.fraction = 0.03, min.node.size = 300, ci.group.size = 100)
# iv.pred.binaryW.model1b <- predict(iv.forest.binaryW.model1b, estimate.variance = TRUE, num.threads = 35)
...
# write.csv(iv.pred.binaryW.model1b, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/IGF1/CAD/01_individual_treatment_effect/ivgrf_full_binaryW_continuousZ_var_model1b.csv")
# write.csv(iv.pred.binaryW.stats.model1b, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/IGF1/CAD/01_individual_treatment_effect/ivgrf_full_binaryW_continuousZ_pvalue_model1b.csv")
...
# write.csv(iv.variable_importance.binaryW.model1b, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/IGF1/CAD/03_variable_importance/ivgrf_binaryW_continuousZ_variable_importance_model1b.csv")
...
#                                        num.threads = 35, num.trees = 5000,
#                                        sample.fraction = 0.03, min.node.size = 300, ci.group.size = 100)
# cf.pred.binaryW.model1b <- predict(causal.forest.binaryW.model1b, estimate.variance = TRUE, num.threads = 35)
...
# write.csv(cf.pred.binaryW.model1b, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/IGF1/CAD/01_individual_treatment_effect/cf_full_binaryW_continuousZ_var_model1b.csv")
# write.csv(cf.pred.binaryW.stats.model1b, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/IGF1/CAD/01_individual_treatment_effect/cf_full_binaryW_continuousZ_pvalue_model1b.csv")
...
#                                          num.threads = 35, num.trees = 5000,
#                                          sample.fraction = 0.03, min.node.size = 300, ci.group.size = 100)
# iv.pred.binaryW.model3 <- predict(iv.forest.binaryW.model3, estimate.variance = TRUE, num.threads = 35)
...
# write.csv(iv.pred.binaryW.model3, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/IGF1/CAD/01_individual_treatment_effect/ivgrf_full_binaryW_continuousZ_var_model3.csv")
# write.csv(iv.pred.binaryW.stats.model3, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/IGF1/CAD/01_individual_treatment_effect/ivgrf_full_binaryW_continuousZ_pvalue_model3.csv")
...
# write.csv(iv.variable_importance.binaryW.model3, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/IGF1/CAD/03_variable_importance/ivgrf_binaryW_continuousZ_variable_importance_model3.csv")
...
#                                        num.threads = 35, num.trees = 5000,
#                                        sample.fraction = 0.03, min.node.size = 300, ci.group.size = 100)
# cf.pred.binaryW.model3 <- predict(causal.forest.binaryW.model3, estimate.variance = TRUE, num.threads = 35)
...
# write.csv(cf.pred.binaryW.model3, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/IGF1/CAD/01_individual_treatment_effect/cf_full_binaryW_continuousZ_var_model3.csv")
# write.csv(cf.pred.binaryW.stats.model3, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/IGF1/CAD/01_individual_treatment_effect/cf_full_binaryW_continuousZ_pvalue_model3.csv")
...
X.set3 <- fread("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/TG/CAD/ukbb.covariate.TG.set3.gz", sep = "\t")

Z.set1 <- fread("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/06_PRS_calculation/TG_GLGC_2021/CAD/set1/1e-08/TG_prs.best", sep = " ") # score_constd
Z.set2 <- fread("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/06_PRS_calculation/TG_GLGC_2021/CAD/set2/1e-08/TG_prs.best", sep = " ") # score_constd
Z.set3 <- fread("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/06_PRS_calculation/TG_GLGC_2021/CAD/set3/1e-08/TG_prs.best", sep = " ") # score_constd
W <- fread("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/04_pheno_covar_data/TG/CAD/ukbb.phenotype.TG.mgdL", sep = "\t")
...
# write.csv(wald.test.res, "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/TG/CAD/01_individual_treatment_effect/wald_test.csv")
...
write.csv(iv.pred.continuousW.model1b, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/TG/CAD/01_individual_treatment_effect/ivgrf_full_continuousW_var_model1b.csv")
write.csv(iv.pred.stats.continuousW.model1b, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/TG/CAD/01_individual_treatment_effect/ivgrf_full_continuousW_pvalue_model1b.csv")
...
write.csv(iv.variable_importance.continuousW.model1b, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/TG/CAD/03_variable_importance/ivgrf_continuousW_variable_importance_model1b.csv")
...
write.csv(cf.pred.model1b, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/TG/CAD/01_individual_treatment_effect/cf_full_continuousW_var_model1b.csv")
write.csv(cf.pred.stats.model1b, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/TG/CAD/01_individual_treatment_effect/cf_full_continuousW_pvalue_model1b.csv")
...
write.csv(iv.pred.continuousW.model3, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/TG/CAD/01_individual_treatment_effect/ivgrf_full_continuousW_var_model3.csv")
write.csv(iv.pred.stats.continuousW.model3, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/TG/CAD/01_individual_treatment_effect/ivgrf_full_continuousW_pvalue_model3.csv")
...
write.csv(iv.variable_importance.continuousW.model3, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/TG/CAD/03_variable_importance/ivgrf_continuousW_variable_importance_model3.csv")
...
write.csv(cf.pred.model3, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/TG/CAD/01_individual_treatment_effect/cf_full_continuousW_var_model3.csv")
write.csv(cf.pred.stats.model3, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/TG/CAD/01_individual_treatment_effect/cf_full_continuousW_pvalue_model3.csv")
...
write.csv(iv.pred.binaryW.model1b, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/TG/CAD/01_individual_treatment_effect/ivgrf_full_binaryW_continuousZ_var_model1b.csv")
write.csv(iv.pred.binaryW.stats.model1b, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/TG/CAD/01_individual_treatment_effect/ivgrf_full_binaryW_continuousZ_pvalue_model1b.csv")
...
write.csv(iv.variable_importance.binaryW.model1b, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/TG/CAD/03_variable_importance/ivgrf_binaryW_continuousZ_variable_importance_model1b.csv")
...
write.csv(cf.pred.binaryW.model1b, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/TG/CAD/01_individual_treatment_effect/cf_full_binaryW_continuousZ_var_model1b.csv")
write.csv(cf.pred.binaryW.stats.model1b, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/TG/CAD/01_individual_treatment_effect/cf_full_binaryW_continuousZ_pvalue_model1b.csv")
...
write.csv(iv.pred.binaryW.model3, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/TG/CAD/01_individual_treatment_effect/ivgrf_full_binaryW_continuousZ_var_model3.csv")
write.csv(iv.pred.binaryW.stats.model3, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/TG/CAD/01_individual_treatment_effect/ivgrf_full_binaryW_continuousZ_pvalue_model3.csv")
...
write.csv(iv.variable_importance.binaryW.model3, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/TG/CAD/03_variable_importance/ivgrf_binaryW_continuousZ_variable_importance_model3.csv")
...
write.csv(cf.pred.binaryW.model3, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/TG/CAD/01_individual_treatment_effect/cf_full_binaryW_continuousZ_var_model3.csv")
write.csv(cf.pred.binaryW.stats.model3, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/TG/CAD/01_individual_treatment_effect/cf_full_binaryW_continuousZ_pvalue_model3.csv")

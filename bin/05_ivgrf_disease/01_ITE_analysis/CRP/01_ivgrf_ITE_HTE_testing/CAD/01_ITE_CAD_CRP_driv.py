...
X_model3_mat = X_model3_mat.astype({
    ...
    "30630-0.0": "float64", "30640-0.0": "float64", "30690-0.0": "float64", "30760-0.0": "float64", "30780-0.0": "float64", "30790-0.0": "float64", "30870-0.0": "float64", # lipid-related covariates
...
X_model3_mat.rename({
    ...
    "30670-0.0": 'Urea', "30770-0.0": 'IGF-1', "30810-0.0": 'Phosphate', "30830-0.0": 'SHBG', "30850-0.0": 'Testosterone', 
...
W_model1b_mat_binary = np.where(W_model1b_mat >= 2.33, 1, 0)
W_model1b_mat_binary = pd.DataFrame({"30710-0.0": W_model1b_mat_binary}).iloc[:, 0]
W_model3_mat_binary = np.where(W_model3_mat >= 2.33, 1, 0)
...
est_driv_continuousW_model1b = ForestDRIV(projection=False, discrete_treatment=False, discrete_instrument=False,
                                         n_estimators=5000, min_samples_leaf=300, max_samples=0.02, cv=5, prel_cv = 5, 
...
est_driv_binaryW_continuousZ_model1b = ForestDRIV(projection=False, discrete_treatment=True, discrete_instrument=False, 
                                     ...
                                     random_state=309, cov_clip = 0.1, n_jobs=35) 
...
full_results_continuousW_model1b.to_csv("/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/CRP/CAD/01_individual_treatment_effect/driv_full_continuousW_te_ul_model1b.csv", sep=",", index=False)
full_results_binaryW_continuousZ_model1b.to_csv("/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/CRP/CAD/01_individual_treatment_effect/driv_full_binaryW_continuousZ_te_ul_model1b.csv", sep=",", index=False)

full_results_continuousW_model3.to_csv("/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/CRP/CAD/01_individual_treatment_effect/driv_full_continuousW_te_ul_model3.csv", sep=",", index=False)
full_results_binaryW_continuousZ_model3.to_csv("/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/CRP/CAD/01_individual_treatment_effect/driv_full_binaryW_continuousZ_te_ul_model3.csv", sep=",", index=False)
...
# print(full_results_binaryW_continuousZ_model3.loc[full_results_binaryW_continuousZ_model3["p_value"] < 0.05, :].shape)
# X_model3_mat_iid_sig_binaryW = X_model3_mat_iid.loc[X_model3_mat_iid["iid"].isin(full_results_binaryW_continuousZ_model3.loc[full_results_binaryW_continuousZ_model3["p_value"] < 0.05, :]["IID"]), :]
# shap_values_driv_binaryW_continuousZ_model3 = est_driv_binaryW_continuousZ_model3.shap_values(X_model3_mat_iid_sig_binaryW)
# save_object(shap_values_driv_binaryW_continuousZ_model3, "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/CRP/CAD/03_variable_importance/driv_binaryW_continuousZ_shap_model3.pkl")
# print("Finished calculating SHAP value on binary W continuous Z model3.")

# print(full_results_continuousW_model3.loc[full_results_continuousW_model3["p_value"] < 0.05, :].shape)
# X_model3_mat_iid_sig_continuousW = X_model3_mat_iid.loc[X_model3_mat_iid["iid"].isin(full_results_continuousW_model3.loc[full_results_continuousW_model3["p_value"] < 0.05, :]["IID"]), :]
# shap_values_driv_continuousW_model3 = est_driv_continuousW_model3.shap_values(X_model3_mat_iid_sig_continuousW)
# save_object(shap_values_driv_continuousW_model3, "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/CRP/CAD/03_variable_importance/driv_continuousW_shap_model3.pkl")

...
X <- fread("~/Project/2023-07-20-individual_MR/dat/04_pheno_covar_data/TC/CAD/ukbb.covariate.TC.complete", sep = "\t")
Z <- fread("~/Project/2023-07-20-individual_MR/dat/06_PRS_calculation/TC/CAD/1e-07/TC_prs.best", sep = " ") # score_constd
W <- fread("~/Project/2023-07-20-individual_MR/dat/04_pheno_covar_data/TC/CAD/ukbb.phenotype.TC.complete.mgdL", sep = "\t")
...
write.csv(permute.test.dat, file = "/home/yujia/Project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/TC/CAD/02_hte_testing/permutationtest_TC_CAD.csv")

...
Z <- fread("~/Project/2022-09-01-individual_MR/dat/06_PRS_calculation/HDL/IST/1e-06/HDL_prs.best", sep = " ") # score_constd
W <- fread("~/Project/2022-09-01-individual_MR/dat/04_pheno_covar_data/HDL/ukbb.phenotype.HDL.complete.mgdL", sep = "\t")
Y <- fread("~/Project/2022-09-01-individual_MR/dat/03_outcome_data/IST_outcome", sep = "\t")

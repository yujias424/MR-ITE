...
Z.set1 <- fread("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/06_PRS_calculation/external_analysis_for_paper_revision/LDPred2/EUR/TC/CAD/set1/TC_prs_0.2.csv", sep = ",") # score_constd
Z.set3 <- fread("/mnt/md0/yujia/project/2023-07-20-individual_MR/dat/06_PRS_calculation/external_analysis_for_paper_revision/LDPred2/EUR/TC/CAD/set1/TC_prs_0.2.csv", sep = ",") # score_constd
...
write.csv(iv.pred.continuousW.model1b, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/extra_analysis_for_paper_revision/02_ITE_analysis/01_table/TC/CAD/01_individual_treatment_effect/ivgrf_full_continuousW_var_model1b_LDPred2.csv")
write.csv(iv.pred.stats.continuousW.model1b, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/extra_analysis_for_paper_revision/02_ITE_analysis/01_table/TC/CAD/01_individual_treatment_effect/ivgrf_full_continuousW_pvalue_model1b_LDPred2.csv")
...
write.csv(iv.pred.continuousW.model3, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/extra_analysis_for_paper_revision/02_ITE_analysis/01_table/TC/CAD/01_individual_treatment_effect/ivgrf_full_continuousW_var_model3_LDPred2.csv")
write.csv(iv.pred.stats.continuousW.model3, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/extra_analysis_for_paper_revision/02_ITE_analysis/01_table/TC/CAD/01_individual_treatment_effect/ivgrf_full_continuousW_pvalue_model3_LDPred2.csv")
...
write.csv(iv.pred.binaryW.model1b, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/extra_analysis_for_paper_revision/02_ITE_analysis/01_table/TC/CAD/01_individual_treatment_effect/ivgrf_full_binaryW_continuousZ_var_model1b_LDPred2.csv")
write.csv(iv.pred.binaryW.stats.model1b, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/extra_analysis_for_paper_revision/02_ITE_analysis/01_table/TC/CAD/01_individual_treatment_effect/ivgrf_full_binaryW_continuousZ_pvalue_model1b_LDPred2.csv")
...
write.csv(iv.pred.binaryW.model3, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/extra_analysis_for_paper_revision/02_ITE_analysis/01_table/TC/CAD/01_individual_treatment_effect/ivgrf_full_binaryW_continuousZ_var_model3_LDPred2.csv")
write.csv(iv.pred.binaryW.stats.model3, file = "/mnt/md0/yujia/project/2023-07-20-individual_MR/res/extra_analysis_for_paper_revision/02_ITE_analysis/01_table/TC/CAD/01_individual_treatment_effect/ivgrf_full_binaryW_continuousZ_pvalue_model3_LDPred2.csv")

...
# write.csv(permute.test.dat.continuousW, file = "/home/yujia/Project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/TC/CAD/02_hte_testing/permutationtest_TC_CAD_continuousW.csv")
...
# write.csv(permute.test.dat.binaryW, file = "/home/yujia/Project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/TC/CAD/02_hte_testing/permutationtest_TC_CAD_binaryW.csv")

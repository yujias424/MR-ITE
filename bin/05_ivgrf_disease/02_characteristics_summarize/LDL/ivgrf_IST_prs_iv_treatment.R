...
#' causal relationship between LDL and ischemic stroke.
#' 
#' @author: Yujia Shi
#' @date: 2022.09.01
...
X <- fread("~/Project/2022-09-01-individual_MR/dat/analysis/pheno_data/LDL/ukbb.covariate.LDL.complete", sep = "\t")
Z <- fread("~/Project/2022-09-01-individual_MR/dat/analysis/prs/mgdL/score_std/LDL/ischemic_stroke/LDL_prs.best", sep = " ")
W <- fread("~/Project/2022-09-01-individual_MR/dat/analysis/pheno_data/LDL/ukbb.phenotype.LDL.complete.mgdL", sep = "\t")
...
setnames(X, c("FID", "IID", "22001-0.0", "4079-0.0", "4080-0.0", "189-0.0",                   
            ...
            c("FID", "IID", "Gender", "diastolic blood pressure", "systolic blood pressure", "Townsend deprivation index",
              ...
              "Non-alcohol drinker", "Previous alcohol drinker", "Current alcohol drinker",
              "Non-smoker", "Previous smoker", "Current smoker",
              "Apolipoprotein A", "HDL-C", "Triglycerides", 
...
samples <- fread("~/Project/2022-09-01-individual_MR/dat/analysis/psm_res/LDL/ischemic_stroke_psm_3.csv")
samples <- samples$sample

W <- W[W$IID %in% samples, c("30780-0.0")]
...
write.csv(continuous_summary, file = "~/Project/2022-09-01-individual_MR/res/table/summary_statistics/LDL_IS_continuous.csv")
write.csv(binary_summary, file = "~/Project/2022-09-01-individual_MR/res/table/summary_statistics/LDL_IS_binary.csv")

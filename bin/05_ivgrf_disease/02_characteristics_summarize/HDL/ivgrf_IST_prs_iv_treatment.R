...
write.csv(continuous_summary, file = "~/Project/2022-09-01-individual_MR/res/table/summary_statistics/HDL_IS_continuous.csv")
write.csv(binary_summary, file = "~/Project/2022-09-01-individual_MR/res/table/summary_statistics/HDL_IS_binary.csv")

...
Z <- fread("~/Project/2022-09-01-individual_MR/dat/06_PRS_calculation/HDL/CAD/1e-07/HDL_prs_WFGS.best", sep = " ") # score_constd
...
W.vector.binary.cutoff <- as.integer(ifelse(X.mat$`Gender` == 0, ifelse(W.vector > 46, 1, 0), ifelse(W.vector > 46, 1, 0)))
...
write.csv(continuous_summary, file = "/home/yujia/Project/2022-09-01-individual_MR/res/02_ITE_analysis/05_summary_statistics/HDL_CAD_continuousW.csv")
write.csv(binary_summary, file = "/home/yujia/Project/2022-09-01-individual_MR/res/02_ITE_analysis/05_summary_statistics/HDL_CAD_binaryW.csv")

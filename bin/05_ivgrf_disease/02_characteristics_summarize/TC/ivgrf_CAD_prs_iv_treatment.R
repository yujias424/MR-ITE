...
#' causal relationship between Total Cholestrol and CAD.
#' 
#' @author: Yujia Shi
#' @date: 2022.09.01
...
write.csv(continuous_summary, file = "/home/yujia/Project/2022-09-01-individual_MR/res/02_ITE_analysis/05_summary_statistics/TC_CAD_continuousW.csv")
write.csv(binary_summary, file = "/home/yujia/Project/2022-09-01-individual_MR/res/02_ITE_analysis/05_summary_statistics/TC_CAD_binaryW.csv")

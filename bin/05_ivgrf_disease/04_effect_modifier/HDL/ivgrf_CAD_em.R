...
#' causal relationship between HDL and heart disease.
#' 
#' @author: Yujia Shi
#' @date: 2022.09.01
...
Z <- fread("~/Project/2022-09-01-individual_MR/dat/analysis/prs/mgdL/score_std/HDL/heart_disease/HDL_prs.best", sep = " ") # score_constd
...
samples <- fread("~/Project/2022-09-01-individual_MR/dat/analysis/psm_res/HDL/heart_disease_psm_2.csv")
...
# Formal Analysis
# ===============
taus <- read.csv("~/Project/2022-09-01-individual_MR/res/table/HDL/heart_disease/treatment_effect/driv_full_binaryWZ_te_ul_trainmodel.csv")
...
write.csv(threshold_regress, file = "~/Project/2022-09-01-individual_MR/res/table/effect_modifiers/segmented_LS/HDL_CAD.csv")
...
write.csv(ols.analysis.df, file = "~/Project/2022-09-01-individual_MR/res/table/effect_modifiers/OLS/HDL_CAD.csv")

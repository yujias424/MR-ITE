...
# Formal Analysis
# ===============
taus <- read.csv("~/Project/2022-09-01-individual_MR/res/table/TG/ischemic_stroke/treatment_effect/driv_full_binaryWZ_te_ul.csv")

threshold_effects_list <- list("Apolipoprotein A" = "segmented",
                               "BMI" = "segmented",
...
write.csv(threshold_regress, file = "~/Project/2022-09-01-individual_MR/res/table/effect_modifiers/segmented_LS/TG_IS.csv")
...
write.csv(ols.analysis.df, file = "~/Project/2022-09-01-individual_MR/res/table/effect_modifiers/OLS/TG_IS.csv")

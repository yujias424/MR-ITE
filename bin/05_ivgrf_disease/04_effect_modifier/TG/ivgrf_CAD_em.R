...
#' causal relationship between Triglycerides and heart disease.
#' 
#' @author: Yujia Shi
#' @date: 2022.09.01
...
Z <- fread("~/Project/2022-09-01-individual_MR/dat/analysis/prs/mgdL/score_std/TG/heart_disease/TG_prs.best", sep = " ")
W <- fread("~/Project/2022-09-01-individual_MR/dat/analysis/pheno_data/TG/ukbb.phenotype.TG.complete.mgdL", sep = "\t")
Y <- fread("~/Project/2022-09-01-individual_MR/dat/analysis/pheno_data/heart_disease_outcome_updated", sep = "\t")
...
Y <- Y[, c("IID", "heart_disease")]

samples <- fread("~/Project/2022-09-01-individual_MR/dat/analysis/psm_res/TG/heart_disease_psm_3.csv")
...
Y.vector <- as.vector(Y$heart_disease)
...
# Formal Analysis
# ===============
taus <- read.csv("~/Project/2022-09-01-individual_MR/res/table/TG/heart_disease/treatment_effect/driv_full_binaryWZ_te_ul_trainmodel.csv")

threshold_effects_list <- list("BMI" = "segmented",
                               "C-reactive protein" = "segmented",
                               "HbA1c" = "segmented",
                               "SHBG" = "segmented",
                               "systolic blood pressure" = "segmented",
                               "Total Cholesterol" = "segmented",
...
write.csv(threshold_regress, file = "~/Project/2022-09-01-individual_MR/res/table/effect_modifiers/segmented_LS/TG_CAD.csv")
...
write.csv(ols.analysis.df, file = "~/Project/2022-09-01-individual_MR/res/table/effect_modifiers/OLS/TG_CAD.csv")

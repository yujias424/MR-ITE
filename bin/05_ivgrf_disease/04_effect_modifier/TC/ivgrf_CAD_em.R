...
#' causal relationship between Total Cholestrol and heart disease.
#' 
#' @author: Yujia Shi
#' @date: 2022.09.01
...
# Continuous W
taus <- read.csv("/home/yujia/Project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/TC/CAD/01_individual_treatment_effect/driv_full_continuousW_te_ul_model3.csv")

threshold_effects_list <- list("Cystatin C" = "segmented",
                               "SHBG" = "segmented",
                               "Vitamin D" = "segmented",
                               "HbA1c" = "segmented",
                               "Calcium" = "segmented",
...
write.csv(threshold_regress, file = "/home/yujia/Project/2023-07-20-individual_MR/res/02_ITE_analysis/04_effct_modifiers/segmented_LS/TC_CAD_continuousW.csv")
...
write.csv(ols.analysis.df, file = "/home/yujia/Project/2023-07-20-individual_MR/res/02_ITE_analysis/04_effct_modifiers/OLS/TC_CAD_continuousW.csv")

# Binary W
taus <- read.csv("/home/yujia/Project/2023-07-20-individual_MR/res/02_ITE_analysis/01_table/TC/CAD/01_individual_treatment_effect/driv_full_binaryW_continuousZ_te_ul_model3.csv")

threshold_effects_list <- list("SHBG" = "segmented",
                               "HbA1c" = "segmented",
...
write.csv(threshold_regress, file = "/home/yujia/Project/2023-07-20-individual_MR/res/02_ITE_analysis/04_effct_modifiers/segmented_LS/TC_CAD_binaryW.csv")
...
write.csv(ols.analysis.df, file = "/home/yujia/Project/2023-07-20-individual_MR/res/02_ITE_analysis/04_effct_modifiers/OLS/TC_CAD_binaryW.csv")
